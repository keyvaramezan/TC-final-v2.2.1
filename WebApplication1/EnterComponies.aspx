        ...
        <div class="content">
            ...
            <div class="bs-example">
                <div class="tab-content">
                    ...
                    <div id="sectionA" style="height:600px;margin:25% auto 0 auto">
                        <div class="nav nav-tabs" id="DivNew">
                            <asp:Button runat="server" CssClass="btn-primary" ID="btnNewTender1" Text="مناقصه جدید" ValidationGroup="4" Width="200" OnClick="btnNewTender_OnClick" />
                        </div>
                        <br /><br />
                        ...
                        <a class="smoth-scroll" href="#sectionB">sadasdasdasdas</a>
                    </div>
                    ...
                    <div id="sectionB" style="height:600px;margin:25% auto">
                    ...
                    <div id="sectionC" style="height:600px;margin:25% auto">
                        <div class="box box2">
                    ...
                    <div id="sectionD" style="height:600px;margin:25% auto">
